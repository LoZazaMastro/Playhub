...
public static class Loc
{
    ...
    {
        ["MergeTitle"] = new[] { "Your settings, all in Playhub", "Le tue impostazioni, tutte in Playhub", "Tus ajustes, todos en Playhub", "Tous vos réglages dans Playhub", "Alle Einstellungen in Playhub", "Todas as suas configurações no Playhub", "Усі налаштування в Playhub", "所有设置，尽在 Playhub", "すべての設定をPlayhubに", "모든 설정을 Playhub에서", "आपकी सभी सेटिंग Playhub में", "Все настройки в Playhub" },
        ["MergeBody"] = new[] { "Quick Settings and Shortcuts are now built into Playhub. Manage your system and customize the quick access menu from one plugin. If the separate plugins are installed, they will be removed and your preferences will be kept.", "Quick Settings e Shortcuts sono ora integrati in Playhub. Gestisci il sistema e personalizza il menu di accesso rapido da un unico plugin. Se i due plugin separati sono installati, verranno rimossi mantenendo le tue preferenze.", "Quick Settings y Shortcuts ahora forman parte de Playhub. Gestiona el sistema y personaliza el menú de acceso rápido desde un solo plugin. Si los plugins independientes están instalados, se eliminarán conservando tus preferencias.", "Quick Settings et Shortcuts sont désormais intégrés à Playhub. Gérez le système et personnalisez le menu d’accès rapide depuis un seul plugin. Les plugins séparés, s’ils sont installés, seront supprimés en conservant vos préférences.", "Quick Settings und Shortcuts sind jetzt in Playhub integriert. Verwalte das System und passe das Schnellzugriffsmenü in einem Plugin an. Installierte Einzel-Plugins werden entfernt. Deine Einstellungen bleiben erhalten.", "Quick Settings e Shortcuts agora fazem parte do Playhub. Gerencie o sistema e personalize o menu de acesso rápido em um só plugin. Se os plugins separados estiverem instalados, serão removidos e suas preferências serão mantidas.", "Quick Settings і Shortcuts тепер інтегровані в Playhub. Керуйте системою та налаштовуйте меню швидкого доступу в одному плагіні. Якщо окремі плагіни встановлено, їх буде видалено зі збереженням ваших налаштувань.", "Quick Settings 和 Shortcuts 现已集成到 Playhub。通过一个插件管理系统并自定义快捷访问菜单。如果已安装这两个独立插件，它们将被移除，您的偏好设置会保留。", "Quick SettingsとShortcutsがPlayhubに統合されました。1つのプラグインでシステムを管理し、クイックアクセスメニューをカスタマイズできます。個別のプラグインがインストールされている場合は削除されますが、設定は引き継がれます。", "Quick Settings와 Shortcuts가 Playhub에 통합되었습니다. 하나의 플러그인에서 시스템을 관리하고 빠른 접근 메뉴를 꾸밀 수 있습니다. 개별 플러그인이 설치되어 있다면 삭제되며 기존 설정은 유지됩니다.", "Quick Settings और Shortcuts अब Playhub में शामिल हैं। एक ही प्लगइन से सिस्टम संभालें और क्विक एक्सेस मेनू को अपनी पसंद के अनुसार बदलें। अलग प्लगइन इंस्टॉल होने पर उन्हें हटाया जाएगा और आपकी प्राथमिकताएँ बनी रहेंगी।", "Quick Settings и Shortcuts теперь встроены в Playhub. Управляйте системой и настраивайте меню быстрого доступа в одном плагине. Если отдельные плагины установлены, они будут удалены с сохранением ваших настроек." },
        ["Version"] = new[]
